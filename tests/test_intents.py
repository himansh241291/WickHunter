...
def test_generate_buy_intents_uses_confirmation_candle():
    sessions = {
        ...
        "2026-01-02": [
            Candle(datetime(2026, 1, 2, 9, 0, tzinfo=timezone.utc), 94.5, 96.5, 94, 96),
            Candle(datetime(2026, 1, 2, 9, 1, tzinfo=timezone.utc), 96, 97, 95.5, 96.5),
        ],
    }
    ...
    assert intent.signal_time == datetime(2026, 1, 2, 9, 0, tzinfo=timezone.utc)
    assert intent.confirmation_time == datetime(2026, 1, 2, 9, 1, tzinfo=timezone.utc)
